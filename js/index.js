...
markets:[
  {
name:"אושר עד",
location:"הועד הלאומי 21 ירושלים",
dist:'',
}
,{
name:"מגה",
location:"הקישון 3 ראשון לציון",
dist:''
}
,{
name:"רמי לוי",
location:"הקישון 3 נתניה",
dist:''
}
,{
name:"שופר סל",
...
dist:''
  ...
  {
name:"אושר עד",
location:"הרצל 21 ראש העין",
dist:''
}
,{
name:"מגה",
location:"הקישון 4 חולון",
dist:''
}
,{
name:"רמי לוי",
location:"התפוח 3 רמת גן",
dist:''
}
,{
name:"שופר סל",
...
computed:{
marketList : function() { return this.markets.sort(function (a, b) {
  return a.dist - b.dist;
});
},
BestMarket : function(){return  this.markets.filter(function(market){ return market.dist <= 50000})}
},
  mounted(){
  },
  methods:{
